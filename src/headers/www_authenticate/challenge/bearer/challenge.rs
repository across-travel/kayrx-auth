...
///
/// ```
/// # use kayrx::web::{web, App, HttpRequest, HttpResponse, HttpServer};
/// use keclc_httpauth::headers::www_authenticate::bearer::{
///     Bearer, Error,
/// };
/// use keclc_httpauth::headers::www_authenticate::WwwAuthenticate;
///
...
impl Bearer {
    ...
    ///
    /// ```
    /// # use keclc_httpauth::headers::www_authenticate::bearer::{Bearer};
    /// let challenge = Bearer::build()
